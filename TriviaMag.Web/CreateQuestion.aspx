...
<asp:Content ID="CreateQuestion" ContentPlaceHolderID="MainContent" runat="server">
    <fieldset>
        ...
        <div class="form-group row">
            <asp:Label ID="categoryLabel" runat="server" AssociatedControlId="categoryDropdown" CssClass="control-label col-md-1">Category:</asp:Label>
        ...
        <asp:Button ID="submitQuestionBtn" runat="server" OnClick="SubmitQuestion" />
    </fieldset>
</asp:Content>
